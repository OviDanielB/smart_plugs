...
#echo "Old HBASE CLASSPATH ${ HBASE_CLASSPATH}"


#echo "New HBASE CLASSPATH ${HBASE_CLASSPATH}"



if [ $HBASE_ROOT_DIR == "" ]
then
    echo "ERROR! You must specify HBASE_ROOT_DIR env var"
    exit 1
fi
...
# change config
sed -i "s|rootDirectory|${HBASE_ROOT_DIR}|g" /hbase/conf/hbase-site.xml
cat /hbase/conf/hbase-site.xml
...
export HBASE_CLASSPATH=/opt/alluxio/client/alluxio-1.7.1-client.jar
#:${HBASE_CLASSPATH}
echo "New HBASE CLASSPATH ${HBASE_CLASSPATH}"
